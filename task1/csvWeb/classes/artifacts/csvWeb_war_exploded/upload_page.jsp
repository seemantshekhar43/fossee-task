...
try{
	...
	String sql = "INSERT INTO data(name,email,phone) VALUES(?,?,?)";
...
<a href = "display.jsp"><button style="display: block; margin: 0 auto;	color: #eee;
		background-color: #666;
		padding: 1rem 2rem;
		border: 0;
		outline: none;">Display Data</button></a>
</BODY>
</HTML>
